...
function topbar(){
  ...
  const label = !P.signedIn?"Not signed in":P.expired?"Access expired":P.pending?"Sync pending":P.noTier?"No access":P.admin?"Admin mode":P.tier?("Active · "+P.tier):"Signed in";
